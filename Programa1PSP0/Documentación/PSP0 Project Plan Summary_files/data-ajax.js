...
function displayUnlockWarning() {
    var msg = "El Process Dashboard calcula automáticamente muchos de los conjuntos de datos por tí. Normalmente, los valores de estos datos calculados no son editables. Eligiendo datos de no solo-lectura hara estos valores editables, permitiendo encimar el valor calculado para tí.\r\n\r\nLos datos de no solo-lectura es útil en ocasiones cuando intencionalmente se quiere encimar un cálculo, pero no esta fuera de riesgo. Una vez encimado un cálculo, se actualizarán en respuesta a los cambios en los datos relacionados. Además, los cálculos relacionados probablemente no se agregen como normalmente esperarías.\r\n\r\n¿Esta seguro de quitar la solo-lectura para los datos?";
    if (window.confirm(msg))
        displayDefaultMessage();
}

function displayDefaultMessage() {
    window.alert("Después de haber encimado un cálculo con algún valor, debes decidir si se quiere regresar a los cáculos anteriores. Solo escribe \r\nDEFAULT\r\nen el campo, y al momento de quitarse del campo regresarán los valores anteriores almacenados.");
    gotoUnLockURL();
}
